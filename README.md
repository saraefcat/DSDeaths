...
installed font, and adjust the counter font size. These choices are restored
when DSDeaths Live starts again. OBS text-output status is grouped directly
below the Elden Ring run-offset panel.
